...
public class CatalogueController {
	...
	public String getItemByBrand(String itemBrand) {
		return this.catalogueService.getItemByBrand(itemBrand);
	}
	...
	public String getItemByColour(String itemColour) {
		return this.catalogueService.getItemByColour(itemColour);
	}
	...
	public String getItemByType(String itemType) {
		return this.catalogueService.getItemByType(itemType);
	}
}
